...
template<class Type>
Foam::cyclicAMIFvPatchField2<Type>::cyclicAMIFvPatchField2
(
    const fvPatch& p,
...
Foam::cyclicAMIFvPatchField2<Type>::cyclicAMIFvPatchField2
(
    const cyclicAMIFvPatchField2<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
template<class Type>
bool Foam::cyclicAMIFvPatchField2<Type>::coupled() const
{
...
Foam::cyclicAMIFvPatchField2<Type>::patchNeighbourField() const
{
...
template<class Type>
const Foam::cyclicAMIFvPatchField2<Type>&
Foam::cyclicAMIFvPatchField2<Type>::neighbourPatchField() const
{
    ...
    return refCast<const cyclicAMIFvPatchField2<Type>>
    (
...
template<class Type>
void Foam::cyclicAMIFvPatchField2<Type>::updateInterfaceMatrix
(
...
template<class Type>
void Foam::cyclicAMIFvPatchField2<Type>::write(Ostream& os) const
{

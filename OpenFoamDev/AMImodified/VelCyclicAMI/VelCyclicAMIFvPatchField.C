...
#include "VelCyclicAMIFvPatchField.H"
#include "transformField.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class Type>
Foam::VelCyclicAMIFvPatchField<Type>::VelCyclicAMIFvPatchField
(
    const fvPatch& p,
...
Foam::VelCyclicAMIFvPatchField<Type>::VelCyclicAMIFvPatchField
(
    const VelCyclicAMIFvPatchField<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
Foam::VelCyclicAMIFvPatchField<Type>::patchNeighbourField() const
{
...
template<class Type>
void Foam::VelCyclicAMIFvPatchField<Type>::updateInterfaceMatrix
(
